...
//             if (msgTokens[0].compareTo("isnr") == 0)
//             {
//                 String[] npcPos = {msgTokens[2], msgTokens[3], msgTokens[4]};
//                 String npcCriteria = msgTokens[5];
...
//     public void sendNPCnearMsg(String[] npcPos, String npcCriteria)
//     {
//         try 
//         {
